...
#ifndef SPREADING_BERNOULLI_H_
#define SPREADING_BERNOULLI_H_

#include <boost/numeric/ublas/vector.hpp>

#include "random_number_generation.h"

double bernoulliMap(const double, const std::vector<double> &);

void generateBernoulliSpreading(boost::numeric::ublas::vector<double> &,
  const std::vector<double> &);

#endif /* SPREADING_BERNOULLI_H_ */
