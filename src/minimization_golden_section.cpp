...
GoldenSection::GoldenSection(const double lower, const double middle,
  const double tolerance) :
    SingleVariableFunctionMinimization(lower, middle), tolerance_(tolerance) {}

double GoldenSection::getAbscissa() const {
  return xOfMin_;
}
