...
#ifndef SPREADING_NEGATIVE_BERNOULLI_H_
#define SPREADING_NEGATIVE_BERNOULLI_H_

#include <boost/numeric/ublas/vector.hpp>

#include "random_number_generation.h"

double negativeBernoulliMap(const double, const std::vector<double> &);

void generateNegativeBernoulliSpreading(boost::numeric::ublas::vector<double> &,
  const std::vector<double> &);

#endif /* SPREADING_NEGATIVE_BERNOULLI_H_ */
