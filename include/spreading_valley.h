...
#ifndef SPREADING_VALLEY_H_
#define SPREADING_VALLEY_H_

#include <boost/numeric/ublas/vector.hpp>

#include "random_number_generation.h"

double valleyMap(const double, const std::vector<double> &);

void generateValleySpreading(boost::numeric::ublas::vector<double> &,
  const std::vector<double> &);

#endif /* SPREADING_VALLEY_H_ */
