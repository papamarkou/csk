...
#ifndef SPREADING_LOGISTIC_H_
#define SPREADING_LOGISTIC_H_
...
double logisticMap(const double);

void initializeLogisticSpreading(std::vector<double> &);

double getLogisticSpreadingMean(const std::vector<double> &);

double getLogisticSpreadingVariance(const std::vector<double> &);

void generateLogisticSpreading(boost::numeric::ublas::vector<double> &,
  const std::vector<double> &);

#endif /* SPREADING_LOGISTIC_H_ */
