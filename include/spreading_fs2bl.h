...
#ifndef SPREADING_FS2BL_H_
#define SPREADING_FS2BL_H_
...
void initializeFs2blSpreading(std::vector<double> &);

double getFs2blSpreadingMean(const std::vector<double> &);

double getFs2blSpreadingVariance(const std::vector<double> &);

#endif /* SPREADING_FS2BL_H_ */
